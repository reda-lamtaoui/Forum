...
<div class="card">
  <?php echo '<img src="'.$UserConnecte->getAvatar().'" style="width:20%;margin-left: auto;
  margin-right: auto;">'; ?>
  <h1><?php echo "".$UserConnecte->getName(); ?></h1>
  <p class="title"><?php echo "".$UserConnecte->getAbout(); ?></p>
  <p>Last connexion: <?php echo "".$UserConnecte->getLastActivity(); ?></p>
  <p><a href="Modifier.php"><button>Modifier</button></a></p>
</div>
    </main>
